...
public class Mailbox extends MailcowModel {
  ...
  public static final BaseClient.Endpoint<Mailbox> ENDPOINT =
      new BaseClient.Endpoint<Mailbox>() {
        @Override
  ...
  int maxNewQuota, isRelayed, activeInt, quotaUsed, percentInUse, messages,
      spamAliases;
  long quota;
  boolean rl;
  ...
  public Mailbox(int maxNewQuota, int isRelayed, int activeInt, int quotaUsed,
                 int percentInUse, int messages, int spamAliases, long quota,
                 boolean rl, String username, String name, String active,
                 String domain, String local_part, String percentClass,
                 Map<String, String> attributes) {
  ...
  public Mailbox() { super(ENDPOINT); }

  public int getMaxNewQuota() { return maxNewQuota; }

  public void setMaxNewQuota(int maxNewQuota) {
    this.maxNewQuota = maxNewQuota;
  }

  public int getIsRelayed() { return isRelayed; }

  public void setIsRelayed(int isRelayed) { this.isRelayed = isRelayed; }

  public int getActiveInt() { return activeInt; }

  public void setActiveInt(int activeInt) { this.activeInt = activeInt; }

  public int getQuotaUsed() { return quotaUsed; }

  public void setQuotaUsed(int quotaUsed) { this.quotaUsed = quotaUsed; }

  public int getPercentInUse() { return percentInUse; }
  ...
  public int getSpamAliases() { return spamAliases; }
  ...
  public boolean isRl() { return rl; }

  public void setRl(boolean rl) { this.rl = rl; }
  ...
  public String getLocal_part() { return local_part; }

  public void setLocal_part(String local_part) { this.local_part = local_part; }

  public String getPercentClass() { return percentClass; }
